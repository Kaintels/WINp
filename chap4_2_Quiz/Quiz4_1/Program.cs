...
namespace Quiz4_1
{
    class Fraction
    {
        ...
        public static Fraction AddFraction(Fraction x1,
       Fraction x2)
        {
            int numerator = x1.numerator * x2.denominator
             + x1.denominator * x2.numerator;
        ...
        public static Fraction SubFraction(Fraction x1,
        Fraction x2)
        {
        ...
        public static Fraction MulFraction(Fraction x1,
       Fraction x2)
        {
        ...
        public static Fraction DivFraction(Fraction x1,
       Fraction x2)
        {
            int numerator = x1.numerator * x2.denominator;
...
class Program
    {
        static void Main(string[] args)
        {
            ...
            c1, c2, Fraction.AddFraction(c1, c2));
            Console.WriteLine("{0} - {1} = {2}",
            c1, c2, Fraction.SubFraction(c1, c2));
            Console.WriteLine("{0} * {1} = {2}",
            c1, c2, Fraction.MulFraction(c1, c2));
            Console.WriteLine("{0} / {1} = {2}",
            c1, c2, Fraction.DivFraction(c1, c2));
        }
    }
}
